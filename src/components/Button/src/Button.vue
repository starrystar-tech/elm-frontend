...
import { ElButton, type ButtonType, type ComponentSize } from 'element-plus'
import { computed, type Component, type PropType, unref } from 'vue'
...
const style = computed(() => {
  if (props.type === 'primary' && !props.link && !props.plain) {
