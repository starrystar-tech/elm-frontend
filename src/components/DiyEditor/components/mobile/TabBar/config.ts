    ...
    items: [
      {
        ...
        iconUrl: 'https://file.bgwa.cn/bgwa/1-001.png',
        activeIconUrl: 'https://file.bgwa.cn/bgwa/1-002.png'
      },
      {
        text: '分类',
        url: '/pages/index/category?id=3',
        iconUrl: 'https://file.bgwa.cn/bgwa/2-001.png',
        activeIconUrl: 'https://file.bgwa.cn/bgwa/2-002.png'
      },
      {
        text: '购物车',
        url: '/pages/index/cart',
        iconUrl: 'https://file.bgwa.cn/bgwa/3-001.png',
        activeIconUrl: 'https://file.bgwa.cn/bgwa/3-002.png'
      },
      {
        text: '我的',
        url: '/pages/index/user',
        iconUrl: 'https://file.bgwa.cn/bgwa/4-001.png',
        activeIconUrl: 'https://file.bgwa.cn/bgwa/4-002.png'
      }
    ]
  }
