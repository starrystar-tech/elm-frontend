                ...
                children: [
                    {
                        path: 'clue',
                        component: () =>
                            import('@/views/system/config/components/ClueConfigTab.vue'),
                    ...
                    },
                    {
                        path: 'order',
                        component: () =>
                            import('@/views/system/config/components/OrderConfigTab.vue'),
                    ...
                    },
                    {
                        path: 'student',
                        component: () =>
                            import('@/views/system/config/components/StudentConfigTab.vue'),
                    ...
                    },
                    {
                        path: 'tag',
                        component: () =>
                            import('@/views/system/config/components/TagConfigTab.vue'),
        ...
        children: [
            {
                ...
                component: () => import('@/views/crm/allocation/engine/index.vue'),
                name: 'CrmAllocationEngine',
                redirect: '/crm/allocation/engine/engine',
                meta: {
                    title: '分配引擎',
                    noCache: true,
                    hidden: true,
                    canTo: true,
                    activeMenu: '/crm/allocation/engine'
                },
                children: [
                    {
                        path: 'engine',
                        component: () => import('@/views/crm/allocation/engine/engine.vue'),
                        name: 'CrmAllocationEngineTab',
                        meta: {
                            title: '分配引擎',
                            noCache: true,
                            hidden: true,
                    ...
                    {
                        path: 'repurchase',
                        component: () => import('@/views/crm/allocation/engine/repurchase.vue'),
                        name: 'CrmAllocationEngineRepurchaseTab',
                        meta: {
                            title: '复购公海',
                            noCache: true,
                            hidden: true,
