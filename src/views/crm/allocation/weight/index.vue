...
const { tableObject, tableMethods, register: tableRegister } = useTable<AllocationWeightApi.AllocationWeightConfigVO>({
...
const openForm = async (type: 'create' | 'update', row?: AllocationWeightApi.AllocationWeightConfigVO) => {
  formType.value = type
...
const tableColumns = computed<TableColumn[]>(() => [
  ...
  },
  {
    ...
    label: '创建时间',
    minWidth: '170px',
    formatter: (_: any, __: any, v: Date) => dateFormatter(v)
  },
  {
    field: 'updateTime',
    label: '更新时间',
  ...
  { field: 'updater', label: '更新人', width: '120px' },
  {
    field: 'action',
    label: '操作',
    width: '160px',
