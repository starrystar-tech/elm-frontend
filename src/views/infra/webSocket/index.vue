...
import { resolveWebSocketUrl } from '@/utils/url'
...
const server = ref(
  `${resolveWebSocketUrl('/infra/ws')}?token=${getRefreshToken()}` // 使用 getRefreshToken() 方法，而不使用 getAccessToken() 方法的原因：WebSocket 无法方便的刷新访问令牌
) // WebSocket 服务地址
