<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="媒体用户id" align="center" prop="userId" />
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, '媒体用户分数.xls')
  } catch {
  } finally {
