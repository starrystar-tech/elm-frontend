...
const {
    ...
    tableMethods,
    register: tableRegister
} = useTable<OperateLogApi.OperateLogVO>({
    getListApi: async (params) =>
        await OperateLogApi.getOperateLogPage({
            ...params,
            action: params.actionKeyword
        }),
    exportListApi: async (params) =>
        await OperateLogApi.exportOperateLog({
            ...params,
            action: params.actionKeyword
        })
})
            ...
            default: (data) =>
                canQuery ? (
                    <BaseButton
                        link
                        type="primary"
                        onClick={() => openDetail(data.row as OperateLogApi.OperateLogVO)}
                    >
                        详情
                    </BaseButton>
                ) : null
