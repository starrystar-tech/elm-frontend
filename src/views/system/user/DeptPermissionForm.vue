<template>
  <Dialog v-model="dialogVisible" title="设置部门权限" width="860px">
    <el-form v-loading="loading" :model="formData" label-width="130px">
      ...
      <el-form-item>
        <el-button type="primary" :loading="saving.campus" @click="submitCampus">保存校区权限</el-button>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" :loading="saving.area" @click="submitArea">保存地区权限</el-button>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" :loading="saving.category" @click="submitCategory">保存项目权限</el-button>
      </el-form-item>
    </el-form>
    <template #footer>
