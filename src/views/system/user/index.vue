                  ...
                  dropdown: () => (
                    <ElDropdownMenu>
                      {checkPermi(['system:user:delete']) ? (
                        <ElDropdownItem command="handleDelete">删除</ElDropdownItem>
                      ) : null}
                      {checkPermi(['system:user:update-password']) ? (
                        <ElDropdownItem command="handleResetPwd">重置密码</ElDropdownItem>
                      ) : null}
                      {checkPermi(['system:permission:assign-user-role']) ? (
                        <ElDropdownItem command="handleRole">分配角色</ElDropdownItem>
                      ) : null}
                    </ElDropdownMenu>
                  )
                }}
